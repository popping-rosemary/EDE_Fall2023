...
> Answer: My previous experiences with data analytics were limited to Excel, SQL, and a bit of data visualization with python. I have no previous expeirence with R. I self-studied Excel and SQL, and I took an intermediate python programming class in undergard. 

2. Are there any components of the course about which you feel confident?

> Answer: I am fairly new to the subject of data analytics, so most of the topics listed on the syllabus are unfamiliar to me. However, my previous work required a lot of modeling work (with Excel), which makes me comfortable working with data. 

3. Are there any components of the course about which you feel apprehensive?

> Answer: I am very excited about the course content. My only worry is my time management, because most of the times coding assignments can be time-consuming (especially when I am taking a modeling class that also requires time commitment). 
...
> Answer: https://github.com/popping-rosemary/EDE_Fall2023
