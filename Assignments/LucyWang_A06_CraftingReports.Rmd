...
```{r boxplot 2018, echo=FALSE, warning = FALSE, fig.height = 3, fig.align='left', fig.cap="Monthly Ozone, 2018"}
Ozone_2018_boxplot <- ggplot(subset(epa_data, Year = 2018), 
                            aes(x= factor(epa_data$Month, levels=1:12, labels = month.abb), y=Ozone))+
  geom_boxplot()+
  xlab("Month")+
...
```{r boxplot 2019, echo=FALSE, warning = FALSE, fig.height = 3, echo = FALSE, fig.align='left', fig.cap="Montly Ozone, 2019"}

Ozone_2019_boxplot <- ggplot(subset(epa_data, Year = 2019), 
                            aes(x= factor(epa_data$Month, levels=1:12, labels=month.abb), y=Ozone))+
  geom_boxplot()+
  ylab("Concentration (µg/m3)")+
  xlab("Month")+
...
## Git Repository
https://github.com/popping-rosemary/EDE_Fall2023
