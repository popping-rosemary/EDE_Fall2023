...
#10
dim(EPAair.O3.PM25.NC1819)

#11
write.csv(EPAair.O3.PM25.NC1819, 
...
> Answer: 'drop_na' can be used in pipelines with 'tidyverse' while 'na.omit' cannot. Using 'drop_na' can tie several operations together with '%>%'. 